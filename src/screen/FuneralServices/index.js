...
const FuneralServicesScreen = ({ navigation, route }) => {
      ...
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <View style={{ width: '100%', paddingHorizontal: 20 }}>
            <Text style={styles.heading}>{data[2].title}</Text>
            <Text style={{
              color: '#fff',
              fontSize: 14,
              alignSelf: 'auto',
            ...
            }}> {data[2].description.replace(regex, '')}</Text>
          </View>
...
export default FuneralServicesScreen;
