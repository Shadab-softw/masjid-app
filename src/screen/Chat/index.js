...
import {getChatApi, getImamChatApi, postChatApi} from '../../services/chatApi';
    ...
    <BgImage>
      <View
        ...
        <Text style={{color: '#FFFFFF', fontSize: 18, marginLeft: 15}}>
          {isCheck === imamName ? `Chat With Imam ${imamName}` : `Chat With ${imamName}` }
        </Text>
      </View>
                ...
                <View
                  ...
                  {state.user.id != item.sender_id ? (
                    <View
                      ...
                      <View style={{ position:'absolute', left:0, marginTop:-20}}>
